...
if __name__ == '__main__':
    ...
    parser_train.add_argument('-p', type=float, default=1.0, help='positive example probability')
    ...
    parser_test.add_argument('-n', type=int, default=0, help='number of distractor examples for each context')
    parser_test.set_defaults(func=test_cmd)

    parser_valid = subparsers.add_parser('valid', help='validset generator')
    parser_valid.add_argument('-n', type=int, default=0, help='number of distractor examples for each context')
